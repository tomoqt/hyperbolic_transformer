...
RUN_NAME_BASE="baseline_L6_N30_lg_23_4_B$NEW_BATCH_SIZE"
echo "Running Experiment (1/8): $RUN_NAME_BASE"
python train.py --configfile="$BASE_CONFIG" \
...
RUN_NAME_SINGLE_MIDDLE="lg_single_middle_2_L6_N30_B$NEW_BATCH_SIZE"
echo "Running Experiment (2/8): $RUN_NAME_SINGLE_MIDDLE (loop_groups=\"[[2]]\", max_loops=30)"
python train.py --configfile="$BASE_CONFIG" \
...
RUN_NAME_SINGLE_EARLY="lg_single_early_0_L6_N30_B$NEW_BATCH_SIZE"
echo "Running Experiment (3/8): $RUN_NAME_SINGLE_EARLY (loop_groups=\"[[0]]\", max_loops=30)"
python train.py --configfile="$BASE_CONFIG" \
...
RUN_NAME_SINGLE_LATE="lg_single_late_5_L6_N30_B$NEW_BATCH_SIZE"
echo "Running Experiment (4/8): $RUN_NAME_SINGLE_LATE (loop_groups=\"[[5]]\", max_loops=30)"
python train.py --configfile="$BASE_CONFIG" \
...
RUN_NAME_EXTREMA="lg_extrema_0_5_L6_N30_B$NEW_BATCH_SIZE"
echo "Running Experiment (5/8): $RUN_NAME_EXTREMA (loop_groups=\"[[0],[5]]\", max_loops=30)"
python train.py --configfile="$BASE_CONFIG" \
...
RUN_NAME_ALL_INDEP_LOW_N="lg_all_independent_L6_N5_B$NEW_BATCH_SIZE"
echo "Running Experiment (6/8): $RUN_NAME_ALL_INDEP_LOW_N (loop_groups=\"[[0],[1],[2],[3],[4],[5]]\", max_loops=5)"
python train.py --configfile="$BASE_CONFIG" \
...
RUN_NAME_ALL_TOGETHER_DEFAULT_N="lg_all_together_L6_N30_B$NEW_BATCH_SIZE"
echo "Running Experiment (7/8): $RUN_NAME_ALL_TOGETHER_DEFAULT_N (loop_groups=\"[[0,1,2,3,4,5]]\", max_loops=30)"
python train.py --configfile="$BASE_CONFIG" \
...
RUN_NAME_ALL_TOGETHER_HIGH_N="lg_all_together_L6_N50_B$NEW_BATCH_SIZE"
echo "Running Experiment (8/8): $RUN_NAME_ALL_TOGETHER_HIGH_N (loop_groups=\"[[0,1,2,3,4,5]]\", max_loops=50)"
python train.py --configfile="$BASE_CONFIG" \
    --wandb_run_name="$RUN_NAME_ALL_TOGETHER_HIGH_N" \
    --loop_groups="[[0,1,2,3,4,5]]" \
    --max_loops=50 \
    --batch_size=$NEW_BATCH_SIZE
echo "Finished Experiment: $RUN_NAME_ALL_TOGETHER_HIGH_N"
echo "--------------------------------------------------"


# Experiment 9: baseline
RUN_NAME_ALL_TOGETHER_HIGH_N="baseline_$NEW_BATCH_SIZE"
echo "Running Experiment (9/9): $RUN_NAME_ALL_TOGETHER_HIGH_N baseline model"
python train.py --configfile="$BASE_CONFIG" \
    --wandb_run_name="$RUN_NAME_ALL_TOGETHER_HIGH_N" \
    --batch_size=$NEW_BATCH_SIZE \
    --used_baseline_model=True
echo "Finished Experiment: $RUN_NAME_ALL_TOGETHER_HIGH_N"
echo "--------------------------------------------------"
